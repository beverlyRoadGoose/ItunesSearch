 ...
 */
public class SoftwareSearch extends Search implements SearchEndpoint<SoftwareSearch, SoftwareAttribute, SoftwareSearchReturnType> {
     ...
     * @return the current instance of {@link SoftwareSearch}
     */
    @Override
    public SoftwareSearch with(String searchTerm) {
     ...
     */
    @Override
    public SoftwareSearch withLimit(int limit) {
        this.limit = limit;
        return this;
    }
     ...
     *
     * @param attribute the software attribute the {@link #searchTerm} is compared with.
     * @return the current instance of {@link SoftwareSearch}
     */
    @Override
     ...
     */
    @Override
    public SoftwareSearch inCountry(CountryCode countryCode) {
     ...
     */
    @Override
    public SoftwareSearch withApiVersion(ItunesApiVersion apiVersion) {
     ...
     */
    @Override
    public SoftwareSearch withReturnLanguage(ReturnLanguage returnLanguage) {
     ...
     */
    @Override
    public SoftwareSearch allowExplicit(boolean allowExplicit) {
