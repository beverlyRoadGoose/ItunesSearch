 ...
 */
public class MovieSearch extends Search implements SearchEndpoint<MovieSearch, MovieAttribute, MovieSearchReturnType> {
     ...
     * @return the current instance of {@link MovieSearch}
     */
    @Override
    public MovieSearch with(String searchTerm) {
     ...
     */
    @Override
    public MovieSearch withLimit(int limit) {
        this.limit = limit;
        return this;
    }
     ...
     */
    @Override
    public MovieSearch inCountry(CountryCode countryCode) {
     ...
     */
    @Override
    public MovieSearch withApiVersion(ItunesApiVersion apiVersion) {
     ...
     */
    @Override
    public MovieSearch withReturnLanguage(ReturnLanguage returnLanguage) {
     ...
     */
    @Override
    public MovieSearch allowExplicit(boolean allowExplicit) {
