 ...
 */
public class EBookSearch extends Search implements SearchEndpoint<EBookSearch, EBookAttribute, EBookSearchReturnType> {
     ...
     */
    @Override
    public EBookSearch with(String searchTerm) {
     ...
     */
    @Override
    public EBookSearch withLimit(int limit) {
        this.limit = limit;
        return this;
    }
     ...
     */
    @Override
    public EBookSearch inCountry(CountryCode countryCode) {
     ...
     */
    @Override
    public EBookSearch withApiVersion(ItunesApiVersion apiVersion) {
     ...
     */
    @Override
    public EBookSearch withReturnLanguage(ReturnLanguage returnLanguage) {
     ...
     */
    @Override
    public EBookSearch allowExplicit(boolean allowExplicit) {
